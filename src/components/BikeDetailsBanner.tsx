    ...
    return (
        <div className=" relative min-h-[80vh] py-4 ">
            <div className="bg-white in-h-[40vh] text-end  max-w space-y-4 p-6 ">
                ...
                <h1 className="lg:text-5xl md:text-3xl text-xl font-extrabold ">  {bike?.name}  </h1>
                <h5 className="text-gray-900 uppercase text-lg font-bold">{bike?.waterproof}-{bike?.waterproof}</h5>
            ...
            <div className="bg-[#B33951] min-h-[60vh] p-6 py-10 relative">
                <div className=" max-w flex flex-col  justify-between  h-full">
                    <div className=" flex justify-end gap-4 flex-1">
                        <button className="  flex items-center gap-3 bg-white px-4  py-1 rounded-sm">Book Now <MoveRight></MoveRight></button>
                        <button className="  flex items-center gap-3 bg-white px-4  py-1 rounded-sm">Add To Cart <ShoppingCart /></button>
